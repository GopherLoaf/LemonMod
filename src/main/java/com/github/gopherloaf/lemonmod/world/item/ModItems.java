...
public class ModItems {
    ...
    public static final RegistryObject<Item> PENULTIMATE_JUICE_BOTTLE = ITEMS.register("penultimate_juice_bottle", () -> new BottleFoodItem(new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEat().nutrition(4 + 3 + 2 + 4 + 5).saturationMod(28.8f).effect(new MobEffectInstance(MobEffects.JUMP, 400, 0), 1.0F).effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 400, 0), 1.0F).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 400, 0), 1.0F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0), 1.0F)
