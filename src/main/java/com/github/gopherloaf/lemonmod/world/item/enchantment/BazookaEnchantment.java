...
public class BazookaEnchantment extends Enchantment {
    public BazookaEnchantment(Rarity p_45107_, EquipmentSlot... p_45108_) {
    ...
    public boolean checkCompatibility(@NotNull Enchantment p_44608_) {
        return super.checkCompatibility(p_44608_) && p_44608_ != ModEnchantments.MULTI_LEMON_LAUNCHER.get();
    }
}
